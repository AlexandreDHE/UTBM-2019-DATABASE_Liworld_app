...
<main class="container mt-5" role="main">
  ...
  @elseif($connecte == 3)
    <form class="range-field my-5" action="">
      <input type="hidden" name="id_user2" value={{$userInfo[0]}} />
      <button class="btn btn-lg btn-success" name="user_id2" value={{$userInfo[0]}} onclick="mettreUneNote();" type="submit">Confirmer</button>
    </form>
  @endif  
